/**
 * Frontend mirror of Backend/utils/containsPhoneNumber.js — keep in sync.
 */
...
export function getListingProseCombined(formData) {
  return [formData?.title, formData?.description].filter(Boolean).join(' ').trim();
}
