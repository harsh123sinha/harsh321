...
import { Users, Building2, UserCog, Briefcase, Target, ClipboardList, HandHelping } from 'lucide-react';
  ...
  <div className="min-h-screen bg-gray-50">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link to="/admin/demands" className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
