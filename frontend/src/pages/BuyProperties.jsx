...
const BuyProperties = () => {
    ...
    <div className="bg-[#0a1020] text-white pb-8 pt-8 sm:pb-10 sm:pt-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 sm:mt-8">
          <SearchBar variant="underline" presetType="buy" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <PropertyCatalogShell catalogKind="buy" presetType="buy" desktopHero={desktopHero}>
      <PaginatedPropertyListing
        queryKey={['properties', 'buy']}
        buildUrl={(limit, offset) => `/properties/type/buy?limit=${limit}&offset=${offset}`}
        demandPrefill={{ category: 'homes', listing_type: 'buy' }}
