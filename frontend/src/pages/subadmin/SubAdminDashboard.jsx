...
import { Users, Building2, Target, ClipboardList, HandHelping } from 'lucide-react';
  ...
  <div className="min-h-screen bg-gray-50">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl">
        ...
        <Link to="/subadmin/subadmin-properties" className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <ClipboardList className="h-12 w-12 text-gold mb-4" />
          <h3 className="text-xl font-bold text-navy">Sub-admin properties</h3>
          <p className="text-sm text-gray mt-2">Listings you added with owner number</p>
        </Link>
        <Link to="/subadmin/demands" className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <HandHelping className="h-12 w-12 text-gold mb-4" />
          <h3 className="text-xl font-bold text-navy">User demands</h3>
          <p className="text-sm text-gray mt-2">Guest property requirements from empty search</p>
        </Link>
        <Link to="/subadmin/mission" className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <Target className="h-12 w-12 text-gold mb-4" />
          <h3 className="text-xl font-bold text-navy">Mission registrations</h3>
          <p className="text-sm text-gray mt-2">Co-ownership interest from the public site</p>
        </Link>
